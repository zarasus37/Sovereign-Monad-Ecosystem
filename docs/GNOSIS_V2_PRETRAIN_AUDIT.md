...
_Generated: 2026-07-21T16:19:54.199650+00:00_
...
- Pairs passing `validate_pair` + non-bootstrap: **128**
- Category counts: `{'CAT1': 19, 'CAT2': 16, 'CAT3': 14, 'CAT4': 15, 'CAT5': 9, 'CAT6': 5, 'CAT7': 5, 'CAT8': 10, 'CAT9': 35}`
...
- Task claimed 71 human-judged pairs; trainable file has 128 validate_pair-ok pairs.
- Training proceeds on `data/preference_pairs_ALL.jsonl` with 128 human-judged pairs.
