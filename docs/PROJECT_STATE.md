...
1. **Onboarding → Live path** — V1–V4.4 + **V5.2 Capacity Ceiling** (`@sovereign/monad-mev` C-DENSITY-FLOOR / throttle / CAPACITY_EXHAUSTED). Remaining: production Hepar organ URL + key custody; wire ceiling into live MEV path; onboarding JSONL → hcd-monitor.
