...
1. **Author CAT9 pairs** — review TTC BATCH 1 candidates in `docs/gnosis-training/TTC_PREFERENCE_PAIRS_GUIDE.md`, write full tripartite chosen/rejected text, promote into `preference_pairs_ALL.jsonl`, run `validate-worksheet` + `ttc-metrics` (target 30).
