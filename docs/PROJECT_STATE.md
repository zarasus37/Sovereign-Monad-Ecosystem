...
1. **Onboarding → Live path** — V1–V4.3 + **V4.4 Hepar forensic gate** (fail-closed HTTP or local stub; mock Hepar `:3002`). Remaining: production Hepar organ URL + key custody; funding status UI; onboarding JSONL → hcd-monitor.
