...
1. **Vector 1 Onboarding Arc — complete (UI + local PL)** — Phase 1 `/onboarding/broken-genesis` · Phase 2 `/onboarding/shadow-market` · Phase 3 `/onboarding/archon-gate` (semiotic blocks, 2 Archon attacks, MESHALEACH_VERIFIED, PL +10/+15/+25). Remaining: onboarding JSONL + hcd-monitor parsers; production Kafka PL; live capital mint/unlock.
