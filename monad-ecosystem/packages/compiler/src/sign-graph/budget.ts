/**
 * L2 SignGraphDialect — pass 3: budgeted expansion.
 *
 ...
 * plex/archive/TTCL_v1_0_BREAKDOWN.md:204`).
 *
 ...
 * `WheelBudgetExceededError` (callers fold it into the constitution verdict).
 */
