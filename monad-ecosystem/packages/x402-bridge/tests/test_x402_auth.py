...
# Add src directory to path for in-tree imports
...
def test_1_imports():
    ...
    try:
        import x402_bridge.quicknode as x402
        log("  ✅ x402_bridge.quicknode imported successfully")
        return True
...
def test_4_eip712_data():
    ...
    try:
        from x402_bridge.quicknode import PaymentRequirement
...
def test_6_module_integration():
    log("\n[6/6] Testing x402_bridge.quicknode module integration...")
    import x402_bridge.quicknode as x402
    import inspect
...
def main(ctx):
    ...
    print("   poetry install  (from the x402-bridge directory)")
    print("   — or —")
    print("   pip install httpx eth-account")
    print("")
    print("4. Run price fetcher smoke test:")
    print("   python -m x402_bridge.price_fetcher")
    print("-" * 60)
