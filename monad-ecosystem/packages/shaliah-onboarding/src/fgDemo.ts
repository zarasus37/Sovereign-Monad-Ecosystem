/**
 * CLI demo: FG-1 → FG-3 happy path with office prompt sample.
 */
import {
  attemptFg1Gate,
  attemptFg2Gate,
...
console.log({ r: s.r, rLocked: s.rLocked, state: s.state });

completeLessonsForGate(s, 'fg1');
const g1 = attemptFg1Gate(s, {
...
console.log('FG-1', g1.passed, s.unlocked);

completeLessonsForGate(s, 'fg2');
const g2 = attemptFg2Gate(s, {
...
console.log('FG-2', g2.passed, g2.failures);

completeLessonsForGate(s, 'fg3');
const g3 = attemptFg3Gate(s, {
...
console.log('FG-3', g3.passed, { r: s.r, rateSovereignty: s.unlocked.rateSovereignty });
