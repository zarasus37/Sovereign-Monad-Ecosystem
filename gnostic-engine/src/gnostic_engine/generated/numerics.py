...
"""
Canonical TTCL numerics for the Python Gnostic Engine (Layer 4a).
...
# ── gnostic_engine ──────────────────────────────────────────────────────────────────
FOCAL_LOCK_THRESHOLD: float = 0.85
BOUNDARY_THRESHOLD: float = 0.65
LANE_B_BLEND_RAW_WEIGHT: float = 0.5
LANE_B_BLEND_VMASK_WEIGHT: float = 0.5
LANE_C_KILL_RHCP_SPIN: float = 0.75
LANE_C_KILL_HOST_RATIO: float = 0.25
LANE_C_KILL_USER_RATIO: float = 0.5
SPIN_EXPANDING_GATE: float = 0.5
MAX_BLINKS: int = 3
MAX_TVL_REFERENCE: int = 500000000

# ── ttcl_constitution ──────────────────────────────────────────────────────────────────
C1_TRIPARTITE_WEIGHT: float = 0.3
C2_LOGIC_COMPRESSION_WEIGHT: float = 0.25
C3_SOURCE_ALIGNED_WEIGHT: float = 0.25
C4_EPISTEMIC_HUMILITY_WEIGHT: float = 0.1
C5_NO_RLHF_SIGNAL_WEIGHT: float = 0.1
PASS_THRESHOLD: float = 0.72

# ── ttcl_logoc_tier ──────────────────────────────────────────────────────────────────
TIER_NEIGHBOR_RADIUS: int = 1
COHERENT_DENSITY_THRESHOLD: float = 0.2
EMERGENT_DENSITY_THRESHOLD: float = 0.08
COHERENT_LANE_B_WEIGHT: int = 1
EMERGENT_LANE_B_WEIGHT: float = 0.7
DIVERGENT_LANE_B_WEIGHT: float = 0.4

# ── ttcl_pps ──────────────────────────────────────────────────────────────────
STATIC_BAND: int = 1
HEAP_BAND: float = 0.65
VOLATILE_BAND: float = 0.3
    ...
    "logoc_manifold": {
      ...
      "constants": {
        "weight_ring": {
          "value": 0.4,
          "unit": "weight",
          "source_doc": "monad-ecosystem/packages/logoc/src/peirce/manifold.ts:18",
        ...
        "weight_angle": {
          "value": 0.3,
          "unit": "weight",
          "source_doc": "monad-ecosystem/packages/logoc/src/peirce/manifold.ts:19",
        ...
        "weight_hamming": {
          "value": 0.3,
          "unit": "weight",
          "source_doc": "monad-ecosystem/packages/logoc/src/peirce/manifold.ts:20",
        ...
        "max_distance": {
          "value": 0.5,
          "unit": "ratio",
          "source_doc": "monad-ecosystem/packages/logoc/src/peirce/manifold.ts:83",
