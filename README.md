...
- **Gnosis Training (Stage 2)** — CPU-verified dry-run of the RewardTrainer locking `gnosis-v2.0-reward`; preference corpus at **91** human-judged pairs (CAT1–5 + CAT6–8 seed + CAT9 **35**); CAT6/7/8 first batch `PP-077`…`091`.
