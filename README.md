...
| **Gnosis Training** | `gnosis-training/` | TTCL Layer 7 Training Pipeline (SFT→Reward→PPO→Eval); real TRL wiring, CPU-verified, GPU run pending | Python (uv) |
