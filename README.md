...
- **Gnosis Training (Stage 2)** — CPU-verified dry-run of the RewardTrainer locking `gnosis-v2.0-reward`; preference corpus at **71** human-judged pairs after UMS Vector 2 CAT9 closeout (`PP-042`…`PP-071`, CAT9 **30/30**, T7/X16/C7).
