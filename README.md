...
- **Gnosis Training (Stage 2)** — CPU-verified dry-run of the RewardTrainer locking `gnosis-v2.0-reward`; preference corpus at **128** human-judged pairs (CAT1–9 all present; CAT8 **10/10** target; CAT9 **35**).
