...
- **Gnosis Training (Stage 2)** — CPU-verified dry-run of the RewardTrainer locking `gnosis-v2.0-reward`; preference corpus at **152** human-judged pairs (CAT5 **21**, CAT6 **17**, CAT8 **10/10**, CAT9 **35**).
