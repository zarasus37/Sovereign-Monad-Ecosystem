...
### Active frontier
- **Code — Layers 6/7 (the unbuilt core):** the Layer 6 Scheduler *core optimizer* landed in PR #38 (`canonical_schedule.json` is generated + byte-reproducible); the data-generation consumer + the real 45-pair Llull PairTable asset are Layer 7 / asset follow-ups. Layer 7 (Training Pipeline: SFT→Reward→PPO→Eval) is the unbuilt core after that.
