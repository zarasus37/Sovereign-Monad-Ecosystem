...
- **Sovereignty remediation (landed):** `x402-bridge` `LEGACY_NON_SOVEREIGN` cleared (2026-07-13, PR #<n>) — the Charter §3 criteria are met: the bridge is wrapped as a sovereign agent (`X402Agent`) with a cost-accounting ledger (`DrawdownLedger`), a documented failure/retry envelope (`RetryEnvelope`), and a sovereign-agent consumer. See `docs/LEGACY_COMPONENTS.md` §6.
